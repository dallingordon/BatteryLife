...
run_cpmlp () {
  ...
  accelerate launch --num_processes 1 --main_process_port 20435 run_main.py \
    ...
    --train_epochs 100 --model_comment "CPMLP_${dataset}_s${seed}" --accumulation_steps 1 \
