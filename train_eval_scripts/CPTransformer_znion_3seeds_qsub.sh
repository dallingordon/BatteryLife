...
#$ -pe omp 4
#$ -j y
#$ -o cptransformer_znion_3seeds.qlog
...
run_cptransformer () {
  ...
  CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 25222 run_main.py \
